...
namespace Lottery.ETL.Common
{
    ...
    public class ImportNumberType
    {
        ...
        private static void ImportJiangXSSC()
        {
            ...
            dict.Add("C522|五星组选好事成双|14", 1.0 / 100000.0);
            dict.Add("C533|五星组选三星报喜|135", 1.0 / 100000.0);
            dict.Add("C544|五星组选四季发财|2500", 1.0 / 100000.0);
        ...
        private static void ImportChongQSSC()
        {
            ...
            dict.Add("C522|五星组选好事成双|0", 1.0 / 100000.0);
            dict.Add("C533|五星组选三星报喜|0", 1.0 / 100000.0);
            dict.Add("C544|五星组选四季发财|0", 1.0 / 100000.0);
        ...
        private static void ImportPL35()
        {
            ...
            dict.Add("C522|前五组选好事成双|0", 1.0 / 100000.0);
            dict.Add("C533|前五组选三星报喜|0", 1.0 / 100000.0);
            dict.Add("C544|前五组选四季发财|0", 1.0 / 100000.0);
