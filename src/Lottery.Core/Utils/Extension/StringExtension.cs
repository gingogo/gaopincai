...
namespace Lottery.Utils
{
    public static class StringExtension
    {
        ...
        private static readonly Regex StripScriptExpression = new Regex("<(/?)script([^><])*>", RegexOptions.IgnoreCase | RegexOptions.Singleline | RegexOptions.Multiline | RegexOptions.CultureInvariant | RegexOptions.Compiled);
        ...
        [DebuggerStepThrough]
        public static string WrapAt(this string target, int index, int dotCount)
        {
            //Check.Argument.IsNotEmpty(target, "target");
            Check.Argument.IsNotNegativeOrZero(index, "index");
        ...
        [DebuggerStepThrough]
        public static string StripScript(this string target)
        {
            return StripScriptExpression.Replace(target, string.Empty);
        }
        ...
        [DebuggerStepThrough]
        public static string Cut(this string target, int length)
        {
        ...
        [DebuggerStepThrough]
        public static string Cut(this string target, int index, int length)
        {
            Check.Argument.IsNotNegative(index, "index");
            Check.Argument.IsNotNegativeOrZero(length, "length");
