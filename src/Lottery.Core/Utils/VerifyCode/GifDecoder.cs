namespace Tgy.Util
{
    ...
    public class GifDecoder
    {
        ...
        protected void DecodeImageData()
        {
            ...
            int num6;
            int num7 = -1;
            int num8 = this.iw * this.ih;
            if ((this.pixels == null) || (this.pixels.Length < num8))
            {
                this.pixels = new byte[num8];
            }
            if (this.prefix == null)
            {
            ...
            while (num18 < num8)
            {
                ...
                num4--;
                this.pixels[num6++] = this.pixelStack[num4];
                num18++;
            }
        ...
        protected int[] ReadColorTable(int ncolors)
        {
            ...
            while (num3 < ncolors)
            {
                ...
                numArray[num3++] = ((-16777216 | (num5 << 0x10)) | (num6 << 8)) | num7;
            }
            return numArray;
        }
