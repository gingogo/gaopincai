    ...
    public class OmissionValueTask : ITask
    {
        ...
        private void FillListView(ListView listView, int precision)
        {
            ...
            foreach (var viewData in this.viewDatas)
            {
                ...
                item.SubItems.Add(viewData.InvestmentValue.ToString("F2"));
                item.SubItems.Add(viewData.ReturnRating.ToString("F2"));
                ...
                item.SubItems.Add(viewData.Frequency.ToString("F2"));           
