...
namespace Lottery.Data.MySQL.D12X3
{
    ...
    /// <summary>
    /// DmDPCDAO提供表(DmDx,DmPx,DmCx)的相关数据访问操作的类。
    /// </summary>
        ...
        : SinglePKDataAccess<DmDPC>,IDmDPCDAO
    {
        ...
        protected override DmDPC DataReaderToEntity(MySqlDataReader dr, MetaDataTable metaDataTable, params string[] columnNames)
        {
            if (dr == null)
