...
namespace Lottery.Data.MySQL.D12X3
{
    using Data.D12X3;
    using Model.D12X3;
    using Utils;

    public class DwNumberDAO : SinglePKDataAccess<DwNumber>,IDwNumberDAO
    {
        /// <summary>
        /// 构造函数。
        /// </summary>
        ...
        public Dictionary<string, int> SelectSpansByNumberTypes(DwNumber number, string dmName, string[] numberTypes)
        {
            ...
            List<NumberIdSeq> numberIdSeqs = this.GetEntities(sqlCmd, null,  this.DataReaderToNumberIdSeq);
        ...
        public string GetPeroidInToday(string numberId, string columnName)
        {
            ...
            object result = MySqlHelper.ExecuteScalar(this.ConnectionString,  sql);
            if (result != null)
