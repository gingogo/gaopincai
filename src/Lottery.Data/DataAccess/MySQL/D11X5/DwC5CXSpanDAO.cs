...
namespace Lottery.Data.MySQL.D11X5
{
    ...
    public class DwC5CXSpanDAO
        : BaseDataAccess<DwC5CXSpan>,IDwC5CXSpanDAO
    {
        /// <summary>
        /// 构造函数。
        /// </summary>
        ...
        protected override DwC5CXSpan DataReaderToEntity(MySqlDataReader dr, MetaDataTable metaDataTable, params string[] columnNames)
        {
            if (dr == null)
