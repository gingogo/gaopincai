...
namespace Lottery.Data.MySQL.Common
{
    ...
    /// <summary>
    /// CategoryDAO提供表(Category)的相关数据访问操作的类。
    /// </summary>
    public class CategoryDAO
        : SinglePKDataAccess<Category>,ICategoryDAO
    {
        /// <summary>
        /// 构造函数。
        /// </summary>
        ...
        protected override Category DataReaderToEntity(MySqlDataReader dr, MetaDataTable metaDataTable, params string[] columnNames)
        {
            if (dr == null)
