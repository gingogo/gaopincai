...
namespace Lottery.Data.MySQL.Common
{
    ...
    public class RuleTypeDAO
        : SinglePKDataAccess<RuleType>,IRuleTypeDAO
    {
        /// <summary>
        /// 构造函数。
        /// </summary>
        ...
        protected override RuleType DataReaderToEntity(MySqlDataReader dr, MetaDataTable metaDataTable, params string[] columnNames)
        {
            if (dr == null)
