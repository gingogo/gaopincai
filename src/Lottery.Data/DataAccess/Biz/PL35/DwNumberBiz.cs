...
namespace Lottery.Data.Biz.PL35
{
    ...
    public class DwNumberBiz : SinglePKDataAccessBiz<IDwNumberDAO, DwNumber>
    {
        ...
        public DwNumber Create(long p, int n, string code, int date, string datetime)
        {
            ...
            number.P4 = number.P5.Substring(0, 4);
            number.P3 = number.P5.Substring(0, 3);
            number.P2 = number.P5.Substring(0, 2);
